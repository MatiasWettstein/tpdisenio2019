...
public class PantallaDarAltaCliente {
	...
	public static void start() {
		...
		lblPas.setFont(new Font("Serif", Font.PLAIN, 18));
		lblPas.setBounds(25, 376, 75, 24);
		marco1.getContentPane().add(lblPas);
		...
		comboBox_Pais.setBounds(110, 381, 193, 20);
		marco1.getContentPane().add(comboBox_Pais);
		comboBox_Pais.setModel(new DefaultComboBoxModel(Pais.values()));
		...
		comboBox_Provincia.setModel(new DefaultComboBoxModel(Provincias.values()));
